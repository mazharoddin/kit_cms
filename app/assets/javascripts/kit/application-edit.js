...
function get_kit_help_link() {
  return $('#kit_help_link a.field_show_more');
}

function get_kit_help_showing() {
  var link = get_kit_help_link();
  if (link==null) return false;
  return link.data('showing');
}

function set_kit_help() {
  var link = get_kit_help_link();
  if (link==null) return false;
  var showing = get_kit_help_showing();
  if (!showing) {
...
function toggle_kit_help(persist) {
  var link = get_kit_help_link();
  if (link==null) return false;
  var showing = get_kit_help_showing();
  showing = !showing;
